...
export function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_8%_9%,rgba(16,185,129,0.14),transparent_27%),radial-gradient(circle_at_91%_14%,rgba(245,158,11,0.11),transparent_24%),linear-gradient(180deg,#fbfefd_0%,#f8fafc_45%,#fff_100%)] text-slate-900 antialiased dark:bg-[radial-gradient(circle_at_8%_9%,rgba(16,185,129,0.08),transparent_27%),radial-gradient(circle_at_91%_14%,rgba(245,158,11,0.05),transparent_24%),linear-gradient(180deg,#020617_0%,#0b1220_45%,#020617_100%)] dark:text-white">
      <DashboardSidebar
        ...
        <header className="sticky top-0 z-20 flex h-[64px] items-center justify-between border-b border-slate-200/80 bg-white/70 px-5 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Button variant="ghost" size="icon" className="relative" aria-label="Notifications">
              ...
              <span className="absolute top-1.5 right-1.5 size-2 rounded-full border-2 border-white bg-emerald-400 dark:border-slate-950" />
            </Button>
            <div className="flex items-center gap-2 rounded-full border border-slate-200/90 bg-white/68 px-2.5 py-1.5 dark:border-white/10 dark:bg-slate-900/50">
              <span className="grid size-7 place-items-center rounded-full bg-slate-100 text-xs font-extrabold text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                AR
              </span>
            </div>
          </div>
