  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        "hover:border-emerald-400/32 hover:shadow-md transition-colors duration-300"
      )}
    >
      {/* Top accent bar indicator on the first metric card or hovered cards */}
      {accentBar && (
        <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-emerald-400 to-transparent" />
      )}
