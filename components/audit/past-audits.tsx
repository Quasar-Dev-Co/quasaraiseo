                ...
                >
                  <td className="border-b border-slate-100 px-5 py-4 dark:border-white/5">
                    <div className="flex items-center gap-2">
                      <span className="grid size-8 shrink-0 place-items-center rounded-[10px] bg-blue-50 text-blue-700 dark:bg-blue-400/10 dark:text-blue-400">
                      ...
                      {isCompleted && (
                        <span className="ml-auto flex items-center gap-1 text-[10px] font-bold text-blue-600 dark:text-blue-400">
