...
export function AuthBrandPanel() {
  return (
    <div className="relative hidden overflow-hidden border-r border-slate-800 bg-slate-950 lg:flex lg:flex-col lg:justify-between lg:p-12">
      {/* Glow effects */}
      <div className="pointer-events-none absolute -top-24 -right-24 size-80 rounded-full bg-blue-600/22 blur-3xl" />
      ...
      <div className="relative flex flex-col gap-6">
        <div className="flex items-center gap-3">
          <span className="grid size-11 place-items-center overflow-hidden rounded-[15px] border border-blue-500/30 bg-slate-950 p-2 shadow-[0_12px_25px_rgba(217,70,239,0.35)]">
          ...
          <span className="text-[22px] font-black tracking-[-0.035em] text-white">
            Quasar<span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">AISEO</span>
          </span>
        </div>
        <div className="inline-flex w-max items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/15 px-3.5 py-2 text-xs font-bold uppercase tracking-[0.16em] text-blue-300">
          <span className="size-2 rounded-full bg-blue-400 shadow-[0_0_0_5px_rgba(217,70,239,0.18)]" />
      ...
      <div className="relative flex flex-col gap-8">
        <div>
          <h2 className="max-w-[440px] text-[clamp(32px,3.5vw,46px)] font-black leading-[1.05] tracking-[-0.05em] text-white">
            ...
            <em className="not-italic bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              AI answers.
            </em>
          </h2>
        ...
        <div className="grid gap-3">
          {features.map((f) => (
            ...
            >
              <span className="grid size-10 shrink-0 place-items-center rounded-[12px] bg-blue-500/20 text-blue-400">
