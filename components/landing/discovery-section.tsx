      ...
      <div className="mx-auto w-full max-w-[1240px]">
        ...
        <div className="mt-8.5 rounded-[28px] border border-slate-200 bg-white p-3.5 shadow-[0_28px_80px_rgba(15,23,42,0.11)]">
          ...
          <div className="grid grid-cols-1 items-center gap-10.5 px-5.5 pb-5.5 pt-7 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              <span className="inline-flex items-center gap-1.75 rounded-full bg-emerald-50 px-2.75 py-2 text-[11px] font-bold text-emerald-700">
              ...
              <div className="mt-5 grid gap-2.5">
                {discovery.points.map((point) => (
                  <span key={point} className="flex items-center gap-2.25 text-xs font-bold text-slate-700">
                    <CheckCircle2 className="size-3.5 text-emerald-600" /> {point}
                  </span>
                ))}
              </div>
            </div>
