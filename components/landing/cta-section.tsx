  ...
  return (
    <section className="px-4 pb-19">
      <div className="mx-auto w-full max-w-[1240px]">
        <div className="grid grid-cols-1 items-center gap-7.5 rounded-[30px] bg-[radial-gradient(circle_at_88%_0,rgba(217,70,239,0.25),transparent_35%),linear-gradient(145deg,#0f172a,#020617)] p-10.5 text-white shadow-[0_36px_120px_rgba(2,6,23,0.35)] lg:grid-cols-[1fr_auto]">
          <div>
          ...
          <div className="flex flex-col gap-2.5 lg:min-w-[190px]">
            <Link
              ...
              className="flex min-h-13 items-center justify-center gap-2 rounded-[15px] bg-gradient-to-r from-fuchsia-600 via-purple-600 to-pink-500 px-6 text-sm font-bold text-white shadow-[0_16px_35px_rgba(217,70,239,0.3)] transition-transform hover:-translate-y-px"
            >
