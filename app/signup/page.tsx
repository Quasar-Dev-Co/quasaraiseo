...
import { ArrowRight, Building2, Check, Eye, EyeOff, Loader2, Lock, Mail, Orbit, TriangleAlert, User } from "lucide-react"
...
const benefits = [
  ...
  "Full SEO reports with scores, keywords, and action plans",
    ...
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1fr_1fr]">
      ...
      <div className="relative flex flex-col items-center justify-center bg-[radial-gradient(circle_at_50%_0%,rgba(16,185,129,0.06),transparent_40%),linear-gradient(180deg,#fbfefd_0%,#f8fafc_50%,#fff_100%)] px-6 py-16">
        ...
        <div className="w-full max-w-[420px]">
          {/* Header */}
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200/60 bg-emerald-50/86 px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.14em] text-emerald-700">
            ...
            <p className="mt-2.5 text-[15px] leading-relaxed text-slate-500">
              Start running professional SEO audits in under two minutes.
            </p>
          </div>
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.14em] text-slate-400">Or sign up with email</span>
            <span className="h-px flex-1 bg-slate-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <label>
                ...
                <div className="relative mt-2.25">
                  <User className="absolute left-3.75 top-1/2 size-[18px] -translate-y-1/2 text-slate-400" />
                  <input
                    name="name"
                    type="text"
              ...
              <label>
                ...
                <div className="relative mt-2.25">
                  <Building2 className="absolute left-3.75 top-1/2 size-[18px] -translate-y-1/2 text-slate-400" />
                  <input
                    name="company"
                    type="text"
            ...
            <label>
              <span className="block text-[13px] font-bold text-slate-700">Work email</span>
              <div className="relative mt-2.25">
            ...
            <label>
              <span className="block text-[13px] font-bold text-slate-700">Password</span>
              <div className="relative mt-2.25">
            ...
            <label className="flex items-start gap-2.5">
              <input
                ...
                required
                className="mt-0.5 size-4.5 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500/20"
              />
              <span className="text-[13px] leading-relaxed text-slate-600">
                I agree to the{" "}
                <Link href="#" className="font-bold text-emerald-600 hover:text-emerald-700">Terms of Service</Link>
                {" "}and{" "}
                <Link href="#" className="font-bold text-emerald-600 hover:text-emerald-700">Privacy Policy</Link>.
              </span>
            </label>
